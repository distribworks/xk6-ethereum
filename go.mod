...
require (
	...
	github.com/grafana/xk6-browser v0.8.1 // indirect
	github.com/grafana/xk6-output-prometheus-remote v0.2.0 // indirect
	...
	go.buf.build/grpc/go/prometheus/prometheus v1.4.7 // indirect
